...
|---|---|---|---|
| Current status | Supported, but no longer updated. Oracle recommends SuiteScript 2.x for new or major updates. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_4284471744.html) | Supported SuiteScript 2.x version. | Latest SuiteScript version. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_156042690639.html) |
| Programming model | Legacy API style using global functions and objects. | Modular API model with defined entry points, context objects, JSDoc annotations, and module loading. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098615298.html) | Same SuiteScript API model as 2.0 in most cases, with newer JavaScript/runtime support and some behavior differences. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/section_158755248128.html) |
| JavaScript / ECMAScript support | Legacy SuiteScript 1.0 JavaScript model. | Oracle describes SuiteScript 2.0 as based on ECMAScript 5.1. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_156042690639.html) | Oracle states that server-side SuiteScript 2.1 uses the Graal runtime and supports ECMAScript 2023. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_156042690639.html) |
| API support | Legacy SuiteScript 1.0 APIs. | SuiteScript 2.x API. | Oracle says the SuiteScript API is the same for 2.0 and 2.1 with exceptions, including `N/llm` and `N/pgp`. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_156042690639.html) |
...
|---|---:|---:|---:|---|
| Bundle Installation | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Bundle Installation as a server script type. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
...
| Custom Tool | No 1.0 documentation | No 2.0 documentation found in current official type name | Documented as SuiteScript 2.1 | Oracle lists this as **SuiteScript 2.1 Custom Tool Script Type** in the current SuiteScript 2.x script type index. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| Map/Reduce | No | Yes | Yes | Oracle says Map/Reduce is a new SuiteScript 2.x script type with no SuiteScript 1.0 equivalent. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html) |
| Mass Update | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Mass Update. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| Portlet | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Portlet. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| RESTlet | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists RESTlet. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| Scheduled Script | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Scheduled Script. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| SDF Installation | No | Yes | Yes | Oracle says SDF Installation is a new SuiteScript 2.x script type with no SuiteScript 1.0 equivalent. [Source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html) |
| Suitelet | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Suitelet. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| User Event | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists User Event. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
| Workflow Action | Yes | Yes | Yes | Oracle says SuiteScript 2.x includes all 1.0 script types, and the 2.x script type index lists Workflow Action. [1.0 → 2.x source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_160098628783.html), [2.x type source](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_4387172495.html) |
...
For new development in NetSuite 2026.1, use SuiteScript 2.1 by default unless the script must run in a documented exception area such as SuiteTax or Scriptable Cart. This recommendation follows Oracle’s statement that SuiteScript 2.1 is the latest version and can be used for server and client scripts, combined with Oracle’s documented exceptions for SuiteTax and Scriptable Cart. [Source: SuiteScript 2.1](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/chapter_156042690639.html)
